...
using namespace std; // FR : Pour pas être obliger de mettre std:: partout

int main() //La porte d'entrée du programme 
{


	setlocale(LC_ALL, "");	// FR : Permet de bien voir les caractère accentués


	int nombre1; //FR : Défénir le premier chiffre que l'utilisateur doit rentrer 
...
//KM : Manque des valeurs négatives dans le plan de tests et aussi 0 !
