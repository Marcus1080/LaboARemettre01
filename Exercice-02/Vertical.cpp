...
using namespace std;	//Pour pas être obliger d'écrire std:: a chaque cout et cin ...
...
int main() //La porte d'entrée du programme 
{
	...
	int nombre2; //Défénir la variable pour le nombre  a cinq chiffres

	

	cout << "Veuillez entrer un nombre a cinq chiffres:  "; //Le premier message que lÈutilisateur voit a l'écran
	...
	else //Sinon ....
	{
		...
		cout <<" 1. " << nombre2 / 10000<< endl; //On affiche les chiffres 1 a 5 pour tout numérotés
		nombre2 = nombre2 % 10000; // On rajoute ceci pour pas voir les chiffres avant le numéro qu'on veux
